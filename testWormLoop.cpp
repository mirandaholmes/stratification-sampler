...
int main(int argc,char *argv[])
{
     ...
     /*  ------  Set up parameters  ------ */
    // Sampling parameters
    int npts = 1000*1000 ;   // how many points to generate
    int dsave = 10;         // how often to save points
    
    // Stratification parameters
    int n = 6;        // number of spheres
    int dim = 3;      // dimension of spheres
    double kappa = 50;  // sticky parameter for making a loop
    VectorXd params(3);
    params << n,dim,kappa;
    int whichcase = 0;
    ...
    // filename
    string filehead("Tests/wormloopStrat_k");
    ...
    //mysampler.write_labels_idx(labelfile);
